...
class search:
    ...
    def ephemeris(self, s, type):
        ...
        #repDict = {"dinucleotide":self.dinucleotide,       # part of auto-iterator shit
        #            "trinucleotide":self.trinucleotide,
        #            "tetranucleotide":self.tetranucleotide,
        #            "pentanucleotide":self.pentanucleotide,
        #            "hexanucleotide":self.hexanucleotide}
        
        if type == 'tetra':
            #for repeatClass in repDict.keys():             # Sort of an auto-iterator thing to try and shorten code
            #    print 'this is repeat class = ', repeatClass
            #    for i in repDict[repeatClass]:
            #        self.genericMethod(i,repeatClass)        
